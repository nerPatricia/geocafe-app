import { LegendInfoModalComponent } from './../../components/legend-info-modal/legend-info-modal';
...
export class OptionsPage {
  ...
  async potencialHidricoModal(cssClass = 'maior-info-modal') {
    const modal = await this.modalCtrl.create({
      component: LegendInfoModalComponent,
      cssClass,
